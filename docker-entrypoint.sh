...
docker_secrets_env() {
    ...
    ACCESS_KEY_FILE="/etc/credentials/secret-key-$APP_NAME/$MINIO_ACCESS_KEY/minio-access-key"
    SECRET_KEY_FILE="/etc/credentials/secret-key-$APP_NAME/$MINIO_SECRET_KEY/minio-secret-key"
